...
public abstract class TalonFuncs {
    ...
    public static void configEncoder(TalonFX talon){
        talon.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative, 0, 0);
    }

    public static void setMotionMagicParams(TalonFX talon, int maxSpeed, int maxAcc){
        talon.configMotionCruiseVelocity(maxSpeed, 0);
        talon.configMotionAcceleration(maxAcc);
    }

    public static void setPIDFConstants(int slot, TalonFX talon, double kP, double kI, double kD, double kF) {
