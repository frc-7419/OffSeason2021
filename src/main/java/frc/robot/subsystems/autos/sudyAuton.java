...
public class sudyAuton extends SequentialCommandGroup {
    public sudyAuton(DriveBaseSub driveBaseSub) {
        addCommands(new StraightPowerTime(driveBaseSub, 0.5, 1000));
        addCommands(new TurnPowerTime(driveBaseSub, 0.5, TurnDirection.RIGHT, 1000));
        addCommands(new StraightPowerTime(driveBaseSub, -0.5, 1000));
        addCommands(new TurnPowerTime(driveBaseSub, 0.5, TurnDirection.LEFT, 1000));
        //Testing this
    }
}
