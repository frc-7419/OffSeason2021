...
public class StartLoader extends ParallelCommandGroup {
  ...
  public StartLoader(ShooterSub shooter, LoaderSub loader, RevolverSub revolver, double shooterSpeed, double revolverSpeed) {
