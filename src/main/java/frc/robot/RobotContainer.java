...
import frc.robot.subsystems.autos.StraightThenBack;
...
public class RobotContainer {
  ...
  private final StraightThenBack straightThenBack = new StraightThenBack(driveBase, gyro);
